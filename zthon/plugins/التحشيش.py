...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗞𝗮𝗶𝗱𝗼 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/Kaido_q) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗞𝗮𝗶𝗱𝗼─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 1207625726 or user.id == 1207625726 or user.id == 1207625726:
