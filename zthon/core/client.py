                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @HAIDAR_MY\
                                  \n\n--------بـدء تتبـع سجـل كـايدو 𝗞𝗔𝗜𝗗𝗢--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع كـايدو 𝗞𝗔𝗜𝗗𝗢--------"
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/HAIDAR_MY)"
                        text = (
                            "**✘ تقـريـر إشعـار كـايدو 𝗞𝗔𝗜𝗗𝗢 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار كـايدو 𝗞𝗔𝗜𝗗𝗢 ✘**\n\n "
                        link = "[HAIDAR(https://t.me/HAIDAR_MY)"
